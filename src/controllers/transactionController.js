...
const updateTransaction = async (req, res) => {
  ...
  try {
    const updatedTransaction = await Transaction.findByIdAndUpdate(
      id,
      { amount, type, description, accountId },
      { new: true }
    );
...
module.exports = { getTransactions, getTransactionById, createTransaction, updateTransaction, deleteTransaction, getBankStatement };
